...
export const TOOL_CATEGORIES: Record<string, ToolCategory> = {
  ...
  bookings: {
    name: 'bookings',
    pattern: /booking|appointment|bookingBusiness|bookingCustomer|bookingService|bookingStaff/i,
    description: 'Microsoft Bookings - businesses, appointments, customers, services, staff',
    requiresOrgMode: true,
  },
  all: {
    name: 'all',
