...
class MicrosoftGraphServer {
  ...
  async initialize(version: string): Promise<void> {
    ...
    // LEAN MODE: Skip specialized graph tools (mail, calendar, etc.)
    // Use graph-request tool for raw API access instead
    // Uncomment below to re-enable specialized tools:
    /*
    ...
    */
    logger.info('Lean mode: Only auth tools + graph-request registered');
  }
